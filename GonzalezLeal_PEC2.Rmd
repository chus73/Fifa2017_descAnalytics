...
pregunta, realizaremos un proceso similar al denominado
`propensity score matching`, aunque un poco simplificado.
...
paired.df <- left_gamers[1:100,] %>% mutate(line_number = row_number())
