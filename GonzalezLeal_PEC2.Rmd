...
En donde vemos que el error de los puntos de observación con respecto a la recta es mínimo.
...
print(paste('Los niveles de confianza se encuentran definidos en el rango [',round(L, 2),', ', round(U, 2), ']')) 
